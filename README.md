...
13. **Comets and Asteroids** — the S, C and M asteroid types as a frozen chemical gradient, dwarf-planet Ceres and volcanic Vesta, the first asteroids visited (Gaspra, Ida, Mathilde, Eros, radar-mapped Toutatis), a comet's nucleus, coma and anti-sunward ion and dust tails, the Kuiper belt and Oort cloud, a comet's primitive life and eventual death, Tunguska, the Moon's cratering record, Shoemaker-Levy 9 and the Spaceguard Survey, and the red centaurs and Jupiter's trapped Trojans.
14. **Cosmic Samples and the Origin of the Solar System** — meteor showers and their radiants, clumpy streams and meteor storms, the meteoroid–meteor–meteorite journey, the Antarctic ice conveyor that concentrates meteorites, stones, irons and stony-irons, the amino acids of Murchison and the ancient inclusions of Allende, the temperature-driven condensation sequence that built the planets, and the protoplanetary disks and hot Jupiters that rewrote how we think planetary systems form.
15. **The Sun: A Garden-Variety Star** — the layered solar interior, the atmosphere that grows hotter outward to a million-degree corona, Cecilia Payne-Gaposchkin's discovery that the Sun is mostly hydrogen and helium, granulation and differential rotation, cool magnetic sunspots and the Zeeman effect, the 11- and 22-year cycles and the solar dynamo, plages, prominences, coronal holes and CMEs, and the space weather that reaches Earth.
16. **The Sun: A Nuclear Powerhouse** — why gravitational contraction and chemical burning fall short, Einstein's E = mc² and the 0.71% mass difference, the 600-million-tons-a-second fuel budget, the proton-proton chain and fusion versus fission, the electrical repulsion that demands a 15-million-K core, energy's 100,000-year random walk through the radiative zone under hydrostatic equilibrium, the neutrinos that escape in eight minutes and Davis's underground detector, and helioseismology and computer models of the hidden interior.
17. **Analyzing Starlight** — apparent brightness versus true luminosity and the inverse-square law, the backwards logarithmic magnitude scale, color as a thermometer via Wien's law, the OBAFGKM spectral sequence and cool L/T/Y brown dwarfs, Annie Jump Cannon and the Huggins' proof that stars share Earth's elements (and what "metals" means), pressure and rotation broadening of spectral lines, and the Doppler shifts and proper motions that give a star's full 3D space velocity.
