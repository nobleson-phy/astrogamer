...
export const styles = {
  ...
  factText: { fontSize: 16.5, lineHeight: 1.6, color: "#dbe4ff", fontFamily: display, fontStyle: "italic" },
  ...
  keyTermText: { fontSize: 15.5, lineHeight: 1.6, color: "#dbe4ff", margin: 0 },
  stagePill: { fontFamily: mono, fontSize: 14, color: C.cool, border: `1px solid ${C.border}`, borderRadius: 20, padding: "5px 12px" },
  stageDesc: { fontSize: 16.5, lineHeight: 1.6, color: "#dbe4ff", marginTop: 12, fontFamily: display, fontStyle: "italic", maxWidth: 460 },
  ...
  explainText: { fontSize: 16.5, lineHeight: 1.6, color: "#dbe4ff", margin: "0 0 14px", fontFamily: display, fontStyle: "italic" },
  ...
  howText: { fontSize: 15.5, color: "#dbe4ff", lineHeight: 1.5 },
